...
public class UserRepository : IUserRepository
{
    ...
    public async Task<UserCreated> AddUser(CreateUser user)
    {
        ...
        {
            ContactNo = user.ContactNo, EmailId = user.EmailId,
    ...
    {
        var userResult = await _collection.AsQueryable().FirstOrDefaultAsync(
        ...
        return new UserCreated() {Username = userResult.Username, ContactNo =
            userResult.ContactNo, EmailId = userResult.EmailId, Password =
            userResult.Password, UserId = userResult.UserId};
    }
